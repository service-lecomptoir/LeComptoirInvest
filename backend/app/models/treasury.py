...
PAYMENT IS BY BANK TRANSFER, IN LARGE AMOUNTS (user, 17 August 2026), and that decides the
shape of everything here. There is no payment provider telling the fund « this investor just
paid ». The fund learns that money exists from its BANK STATEMENT, and the whole difficulty
is attribution: a transfer carries an amount, a date, a label and the name of whoever
ordered it, and none of those is an investor identifier.
